...
|----------|-------------|--------|---------|
| Client legal name | `{{CLIENT_LEGAL_NAME}}` | Notion brief → Company | Jane Doe Consulting |
| Client address | `{{CLIENT_ADDRESS}}` | Notion brief → Address | Paris, France |
| Client representative | `{{CLIENT_REPRESENTATIVE}}` | Notion brief → Contact | Jane Doe |
...
| Neurogrid representative | `{{NEUROGRID_REPRESENTATIVE}}` | Config | John Doe |
